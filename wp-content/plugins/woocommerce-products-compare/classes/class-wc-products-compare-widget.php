...
class WC_Products_Compare_Widget extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		$html .= '<a href="' . esc_url( site_url() . '/' . $endpoint  ) . '" title="' . esc_attr( 'Compare Products', 'woocommerce-products-compare' ) . '" class="button woocommerce-products-compare-widget-compare-button">' . __( 'Compare Products', 'wocommerce-products-compare' ) . '</a>' . PHP_EOL;
