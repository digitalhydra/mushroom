...
if ( is_woocommerce_active() ) {
	...
	class WC_Shipping_Per_Product_Init {
		...
		public function __construct() {
			define( 'PER_PRODUCT_SHIPPING_VERSION', '2.2.0' );
		...
		public function register_importer() {
			if ( defined( 'WP_LOAD_IMPORTERS' ) ) {
				register_importer( 'woocommerce_per_product_shipping_csv', __( 'WooCommerce Per-product shipping rates (CSV)', 'woocommerce' ), __( 'Import <strong>per-product shipping rates</strong> to your store via a csv file.', 'woocommerce'), array( $this, 'importer' ) );
			}
		}
