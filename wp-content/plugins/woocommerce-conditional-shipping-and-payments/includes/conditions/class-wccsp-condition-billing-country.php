...
class WC_CSP_Condition_Billing_Country extends WC_CSP_Condition {
	...
	public function __construct() {
		...
		$this->title                          = __( 'Billing Country', WC_Conditional_Shipping_Payments::TEXT_DOMAIN );
	...
	public function get_condition_resolution( $data, $args ) {
		...
		if ( $data[ 'modifier' ] === 'in' && in_array( $billing_country, $data[ 'value' ] ) ) {
			return __( 'select a different billing country', WC_Conditional_Shipping_Payments::TEXT_DOMAIN );
