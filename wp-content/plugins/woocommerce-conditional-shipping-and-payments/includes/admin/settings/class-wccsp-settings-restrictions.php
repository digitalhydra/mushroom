...
class WC_Settings_Restrictions extends WC_Settings_Page {
	...
	public function get_settings() {
		...
		return apply_filters( 'woocommerce_csp_settings', array(
			...
			array(
				...
				'type'  => 'title',
				'desc'  => __( 'Use Restrictions to conditionally disable Payment Gateways, Shipping Methods and Shipping Countries or States.', WC_Conditional_Shipping_Payments::TEXT_DOMAIN ),
			...
			array(
				'title' => __( 'Debug Options', WC_Conditional_Shipping_Payments::TEXT_DOMAIN ),
				'type'  => 'title',
				'desc'  => __( 'Use the following options to temporarily disable all defined Restrictions, for example if you need to troubleshoot your payment and shipping settings.', WC_Conditional_Shipping_Payments::TEXT_DOMAIN ),
	...
	public function restrictions_overview() {
		...
		?>
		<tr valign="top">
			<th scope="row" class="titledesc"><?php _e( 'Restrictions Overview', WC_Conditional_Shipping_Payments::TEXT_DOMAIN ) ?></th>
			<td class="forminp">
				<table class="wc_shipping wc_restrictions_overview widefat wp-list-table" cellspacing="0">
					<thead>
						<tr>
							<th class="name"><?php _e( 'Restriction Type', WC_Conditional_Shipping_Payments::TEXT_DOMAIN ); ?></th>
							<th class="status"><?php _e( 'Active Rules', WC_Conditional_Shipping_Payments::TEXT_DOMAIN ); ?></th>
							<th class="summary"><?php _e( 'Summary', WC_Conditional_Shipping_Payments::TEXT_DOMAIN ); ?></th>
						</tr>
					</thead>
					<tbody>
