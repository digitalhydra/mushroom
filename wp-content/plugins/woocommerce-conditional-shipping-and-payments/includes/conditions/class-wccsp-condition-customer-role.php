...
class WC_CSP_Condition_Customer_Role extends WC_CSP_Condition {
	...
	public function __construct() {
		...
		$this->title                          = __( 'Customer Role', WC_Conditional_Shipping_Payments::TEXT_DOMAIN );
	...
	public function get_condition_resolution( $data, $args ) {
		...
		if ( $data[ 'modifier' ] === 'in' && $identified_role ) {
			return __( 'check out using an account with elevated permissions', WC_Conditional_Shipping_Payments::TEXT_DOMAIN );
	...
	public function get_admin_fields_html( $index, $condition_index, $condition_data ) {
		...
		$wp_roles                 = wp_roles();
		$wp_role_names[ 'guest' ] = __( 'Guest', WC_Conditional_Shipping_Payments::TEXT_DOMAIN );
